...
<head>
    ...
    <title>Register - POS Application</title>
...
<body>
    <div class="register-container fade-in">
        <div class="register-header">
            ...
            <p class="mb-0 opacity-75">Buat akun baru untuk mengakses POS System</p>
        </div>
            ...
            <form method="POST" action="{{ route('register') }}">
                ...
                <div class="mb-3">
                    ...
                    <div class="input-group">
                        ...
                        <select class="form-select with-icon @error('role') is-invalid @enderror" 
                                id="role" 
                                name="role" 
                                required>
