                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('purchases.update', $purchase) }}">
                            ...
                            <div class="col-md-6">
                                <div class="payment-dropdown">
                                    <select id="payment_method" class="form-control @error('payment_method') is-invalid @enderror" name="payment_method" required>
                                        ...
                                        <option value="transfer" {{ old('payment_method', $purchase->payment_method) == 'transfer' ? 'selected' : '' }}>Transfer</option>
                            ...
                            <table class="table table-bordered" id="purchase-items">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input type="number" class="form-control price" name="items[{{ $index }}][unit_price]" step="0.01" min="0" value="{{ $item->unit_price }}" required>
                                        </td>
                                        <td>
                                            <input type="number" class="form-control subtotal" name="items[{{ $index }}][subtotal]" step="0.01" min="0" value="{{ $item->total_price }}" readonly>
                                        </td>
                                        <td>
                        ...
                        <div class="form-group row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="total_amount" type="number" class="form-control" name="total_amount" step="0.01" min="0" value="{{ $purchase->total_amount }}" readonly>
                            </div>
                        </div>
                        ...
                        <div class="form-group row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="paid_amount" type="number" class="form-control @error('paid_amount') is-invalid @enderror" name="paid_amount" step="0.01" min="0" value="{{ old('paid_amount', $purchase->paid_amount) }}" required>
                                @error('paid_amount')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="form-group row mb-3">
                            ...
                            <div class="col-md-6">
                                <textarea id="notes" class="form-control @error('notes') is-invalid @enderror" name="notes">{{ old('notes', $purchase->notes) }}</textarea>
                                @error('notes')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
