<?php $__env->startSection('title', 'Manajemen Produk - POS Application'); ?>
        ...
        <form method="GET" action="<?php echo e(route('products.index')); ?>" class="d-flex">
            ...
            <div class="product-filter-dropdown me-2">
                <select name="stock_status" class="form-select" style="min-width: 150px;">
                    ...
                    <option value="low" <?php echo e(request('stock_status') == 'low' ? 'selected' : ''); ?>>Stok Rendah</option>
            ...
            <table class="table table-bordered table-hover">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <span class="badge bg-primary"><?php echo e($product->code ?? 'N/A'); ?></span>
                        </td>
                        <td>
                        ...
                        <td>
                            <?php if($product->barcode): ?>
                                <code><?php echo e($product->barcode); ?></code>
                            <?php else: ?>
                        ...
                        <td>
                            <span class="badge <?php echo e($product->isLowStock() ? 'bg-warning' : 'bg-success'); ?>">
                                <?php echo e($product->stock); ?> <?php echo e($product->unit->symbol); ?>
                        ...
                        <td>
                            <div class="btn-group" role="group">
                                ...
                                <form action="<?php echo e(route('products.toggle-status', $product)); ?>" 
                                      method="POST" 
                                      class="d-inline">
                                    <?php echo csrf_field(); ?>
                                    <button type="submit" 
                                            ...
                                            onclick="return confirm('Yakin ingin <?php echo e($product->is_active ? 'menonaktifkan' : 'mengaktifkan'); ?> produk ini?')">
                                        <i class="fas <?php echo e($product->is_active ? 'fa-eye-slash' : 'fa-eye'); ?>"></i>
                                    </button>
                                </form>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\PIXELLABS\Aplikasi POS Cursor\resources\views/products/index.blade.php ENDPATH**/ ?>