        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <span><?php echo e(__('Units')); ?></span>
                    <a href="<?php echo e(route('units.create')); ?>" class="btn btn-primary btn-sm">Tambah Data Satuan</a>
                </div>
                ...
                <div class="card-body">
                        ...
                        <table class="table table-bordered table-striped">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="<?php echo e(route('units.edit', $unit->id)); ?>" class="btn btn-primary btn-sm"><?php echo e(__('Edit')); ?></a>
                    ...
                    <?php if(isset($units) && $units->hasPages()): ?>
                        <div class="mt-4">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\PIXELLABS\Aplikasi POS Cursor\resources\views/units/index.blade.php ENDPATH**/ ?>