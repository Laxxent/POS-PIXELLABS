...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'POS Application'); ?></title>
            ...
            <nav class="col-md-3 col-lg-2 d-md-block sidebar collapse">
                <div class="position-sticky pt-3">
                    ...
                    <ul class="nav flex-column">
                        ...
                        <li class="nav-item">
                            <a class="nav-link <?php echo e(request()->routeIs('units.*') ? 'active' : ''); ?>" 
                        ...
                        <li class="nav-item">
                            <a class="nav-link <?php echo e(request()->routeIs('suppliers.*') ? 'active' : ''); ?>" 
                        ...
                        <li class="nav-item">
                            <a class="nav-link <?php echo e(request()->routeIs('sales.*') ? 'active' : ''); ?>" 
                        ...
                        <li class="nav-item">
                            <a class="nav-link <?php echo e(request()->routeIs('purchases.*') ? 'active' : ''); ?>" 
                        ...
                        <li class="nav-item">
                            <a class="nav-link <?php echo e(request()->routeIs('store-settings.*') ? 'active' : ''); ?>" 
                               href="<?php echo e(route('store-settings.index')); ?>">
                    ...
                    <div class="container-fluid">
                        <div class="d-flex align-items-center">
                            <h1 class="navbar-brand mb-0">
                                <?php echo $__env->yieldContent('page-title', 'POS Application'); ?>
                            </h1>
                        </div>
                        ...
                        <div class="navbar-nav ms-auto">
                            <div class="nav-item dropdown">
                                <div class="user-info dropdown-toggle" 
                                    ...
                                    <div class="user-avatar">
                                        <?php if(Auth::user()->avatar): ?>
                                            <img src="<?php echo e(asset('storage/' . Auth::user()->avatar)); ?>" alt="Avatar" style="width: 100%; height: 100%; object-fit: cover; border-radius: 50%;">
                                        <?php else: ?>
                                ...
                                <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                                    ...
                                    <li>
                                        <a class="dropdown-item" href="<?php echo e(route('store-settings.index')); ?>">
...
<?php /**PATH C:\PIXELLABS\Aplikasi POS Cursor\resources\views/layouts/app.blade.php ENDPATH**/ ?>